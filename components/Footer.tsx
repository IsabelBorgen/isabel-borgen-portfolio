  ...
  return (
    ...
    >
      <div className="container-xl flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-sm text-[var(--bg)] opacity-60">
          © {year} Isabel Borgen · Built with purpose in Barcelona
        </p>
        ...
        <div className="flex items-center gap-5">
          ...
          <a
            ...
            className="text-[var(--bg)] opacity-60 hover:opacity-100 transition-opacity cursor-pointer"
          >
          ...
          <a
            ...
            aria-label="Send email to Isabel"
            className="text-[var(--bg)] opacity-60 hover:opacity-100 transition-opacity cursor-pointer"
          >
